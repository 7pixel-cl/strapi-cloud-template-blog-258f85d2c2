...
export interface ApiAnnouncementBannerAnnouncementBanner
  extends Struct.CollectionTypeSchema {
  collectionName: 'announcement_banners';
  info: {
    description: 'Announcement banners that appear on the website';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::announcement-banner.announcement-banner'
    > &
      Schema.Attribute.Private;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    blocks: Schema.Attribute.DynamicZone<
      ['shared.media', 'shared.quote', 'shared.rich-text', 'shared.slider']
    >;
    cardImageAlt: Schema.Attribute.String;
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  collectionName: 'faqs';
  info: {
    description: 'Frequently Asked Questions for the school website';
    displayName: 'FAQ';
    pluralName: 'faqs';
    singularName: 'faq';
  };
...
export interface ApiFeatureTabFeatureTab extends Struct.CollectionTypeSchema {
  collectionName: 'feature_tabs';
  info: {
    description: 'Tabbed feature sections with images for school life showcase';
    displayName: 'Feature Tab';
    pluralName: 'feature-tabs';
    singularName: 'feature-tab';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFeatureFeature extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'School educational pillars and features';
    displayName: 'Feature';
    pluralName: 'features';
  ...
  attributes: {
    ...
    icon: Schema.Attribute.Enumeration<
      ['groups', 'verified', 'books', 'frame', 'tools', 'dashboard', 'house']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiFeaturesSectionFeaturesSection
  ...
  info: {
    description: 'Features/Pillars section with title, subtitle, and image';
...
export interface ApiHomepageHeroHomepageHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    ratingText: Schema.Attribute.RichText;
    reviewsText: Schema.Attribute.RichText;
    secondaryButtonText: Schema.Attribute.String;
    secondaryButtonURL: Schema.Attribute.String;
    showReviewSection: Schema.Attribute.Boolean &
...
export interface ApiPageSectionPageSection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reusable content sections for different pages';
  ...
  attributes: {
    buttonExists: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    isRightSection: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    page: Schema.Attribute.Enumeration<
      ['nosotros', 'academico', 'admision', 'servicios']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    single: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    subtitle: Schema.Attribute.Text & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Partner organizations and institutional affiliations';
    displayName: 'Partner';
    pluralName: 'partners';
...
export interface ApiStatisticStatistic extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Statistics and metrics displayed on the website';
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Parent, teacher, and student testimonials';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::feature-tab.feature-tab': ApiFeatureTabFeatureTab;
